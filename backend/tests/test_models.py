...
def test_prepare_model_frame_casts_bool_and_fills_categorical_na():
    df = pd.DataFrame({
        ...
        "neighbor_hotspot_frequency": [0.0, 0.0, 0.0],
        "neighbor_violation_density": [0.0, 0.0, 0.0],
        "neighbor_junction_density": [0.0, 0.0, 0.0],
        "neighbor_police_station_density": [0.0, 0.0, 0.0],
        "neighbor_rolling_hotspot_intensity": [0.0, 0.0, 0.0],
        "neighbor_violations_last_15m": [0.0, 0.0, 0.0],
        "hour": [0, 12, 23],
        "weekday": [0, 1, 2],
